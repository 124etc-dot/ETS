...
export const DashboardTab: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      {/* Module 2: Фінансовий баланс Рахунків (Горизонтальна панель огляду) */}
      <div className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-slate-100 gap-2">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                Фінансовий стан оплат постачальникам за даними Google Таблиці
              </p>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={() => onSelectTab('sheet')}
            className="text-xs text-emerald-700 hover:text-emerald-900 font-semibold flex items-center gap-1 cursor-pointer transition-colors self-end sm:self-auto"
          >
            <span>Реєстр рахунків</span>
            <ChevronRight className="w-3.5 h-3.5" />
          </button>
        </div>

        {/* Visual breakdown cards: 3-column horizontal grid */}
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Card 1: Оплачено постачальникам */}
          <div className="p-3.5 bg-emerald-50/60 rounded-xl border border-emerald-200/80 flex flex-col justify-between">
            ...
            <div className="mt-2 text-right text-[10px] text-emerald-700 font-mono font-semibold">
              {invoiceStats.paidPercentage}% від загальної суми
            </div>
          </div>

          {/* Card 2: Залишок до сплати */}
          <div className="p-3.5 bg-amber-50/60 rounded-xl border border-amber-200/80 flex flex-col justify-between">
            ...
            <div className="mt-2 text-right text-[10px] text-amber-700 font-mono font-semibold">
              {100 - invoiceStats.paidPercentage}% очікує оплати
            </div>
          </div>

          {/* Card 3: Розподіл за статусами */}
      ...
      {/* Aligned Workspaces Grid: Real Projects Monitor (left, 7 cols) & Manager Approval (right, 5 cols) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        {/* Module 1: Реальні дані проєктів у стислому вигляді (7 cols) */}
        <div className="lg:col-span-7 flex flex-col">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-xs flex flex-col justify-between h-full">
            ...
            {/* Concise Real Projects List (Scrollable to match height with Manager Approval) */}
            <div className="mt-3.5 space-y-2.5 flex-1 min-h-0 overflow-y-auto pr-1 sm:pr-2 max-h-[580px] lg:max-h-[600px] focus:outline-hidden">
          ...
          <div className="mt-4 pt-3 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-2.5 shrink-0">
      ...
      {/* Module 3: 📄 На погодження керівнику (5 cols, side-by-side with projects monitor) */}
      ...
      {selectedProject && (
        ...
        >
          <div 
            className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-scaleIn relative"
          ...
          >
              ...
              <div className="flex items-center space-x-2.5 sm:space-x-3 min-w-0 pr-2">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="font-bold text-slate-900 font-mono bg-blue-50 text-blue-700 border border-blue-200 px-2.5 py-0.5 rounded-lg text-sm">
                  ...
                  <h3 className="text-sm sm:text-base font-bold text-slate-900 leading-snug mt-1 truncate">
            ...
            <div className="p-4 sm:p-6 overflow-y-auto flex-1 min-h-0 space-y-4 text-xs">
              {/* Object / Details if different from Name */}
          ...
          {/* Modal Sticky / Fixed Footer */}
          <div className="p-3.5 sm:p-4 border-t border-slate-100 bg-slate-50/80 shrink-0 flex items-center justify-end space-x-2">
            <button
              type="button"
              onClick={() => setSelectedProject(null)}
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer shadow-xs"
            >

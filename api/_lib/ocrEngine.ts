...
export function detectAndNormalizeMimeType(base64: string, fallbackMime: string, fileName?: string): string {
...
export function parseAmountToNumber(val: any): number {
...
export async function processOcrDocument(params: ProcessOcrParams): Promise<{
  success: boolean;
  data?: any;
  fileName?: string;
  error?: string;
